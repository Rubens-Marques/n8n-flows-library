# n8n Flows Library — project profile (Nexus Harness v4)

Nexus registry id: `projects.n8n-flows-library`
Repository: `Rubens-Marques/n8n-flows-library`
Client: `nexus`
Status: `active`
...
- Biblioteca de fluxos n8n. Sem workflow GitHub legado.

## Commands

Sem suíte de app neste gate. Contrato do adapter + Trivy.
